...
typedef enum {
    FG_OK=0, G_NULL, G_MALLOC, G_REALLOC, G_READ, G_WRITE , G_INDEX, G_NOREAD, G_READFAIL,
    ...
    ERR_NULL, ERR_FOPEN, F_FORMAT, AREP_PARSE, AREP_INDEX, ERRFLAG_INVALIDOPT,
    ERRFLAG_INVALID_ARG, AREP_INVALID ,
